      ...
      layers: [
        {
          ...
          config: {
            dataId: 'grid_cells',
            label: 'Lion Density (individuals per km²)',
            color: [33, 102, 172],
            columns: { lat: 'latitude', lng: 'longitude' },
            isVisible: true,
            visConfig: {
        ...
        tooltip: {
          fieldsToShow: {
            grid_cells: [
              ...
              { name: 'nightlight_intensity', format: '.4f' },
              { name: 'nightlight_trend', format: '.5f' },
              { name: 'distance_to_protected_km', format: '.1f' },
              { name: 'management_unit', format: null },
              { name: 'longterm_slope_mean', format: '.5f' },
              { name: 'all_skew_mean', format: '.3f' },
            ],
            protected_areas: [
              { name: 'site_name', format: null },
              { name: 'designation', format: null },
              { name: 'iucn_category', format: null },
              { name: 'area_km2', format: '.1f' },
              { name: 'year_established', format: null },
            ],
          },
          compareMode: false,
          compareType: 'absolute',
