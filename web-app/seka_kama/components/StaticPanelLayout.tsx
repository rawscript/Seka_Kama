...
import { Grid3x3, Sidebar, LayoutDashboard, ChevronUp, ChevronDown } from 'lucide-react';
...
// Grid Layout - Clean organized grid (moved outside)
const GridLayout = ({
  analystPanel,
  ecosystemPanel,
  layerPanel,
...
// Sidebar Layout - Tabbed interface (moved outside)
const SidebarLayout = ({
  analystPanel,
  ecosystemPanel,
  layerPanel,
...
// Overlay Layout - Minimal floating controls (moved outside)
const OverlayLayout = ({
  analystPanel,
  selectedUnit,
  year,
