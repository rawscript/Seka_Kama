...
- **Unprofessional Conduct**: The use of sexualized language or imagery and unwelcome sexual attention or advances.
...
## 3. Data & Intellectual Property Responsibilities

As a spatial project, we have specific ethical obligations:

- **Attribution**: All contributors must respect the intellectual property of our data providers, including UNEP-WCMC and IUCN, and cite sources according to the official WDPA/OECM guidelines.
- **Informed Consent**: When working with data involving indigenous peoples or local communities, contributors must respect the principles of free, prior, and informed consent (FPIC).
